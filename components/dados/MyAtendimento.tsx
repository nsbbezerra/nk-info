...
import { BiPhoneCall, BiPlus, BiSearch } from "react-icons/bi";
import Button from "../layout/Button";

export default function MyAtendimento() {
  return (
    <Fragment>
      <div className="px-4 py-5 sm:px-6 rounded-md border">
        <h3 className="text-lg font-medium leading-6 text-gray-900">
          Meus Atendimentos: Abril de 2022
        </h3>
      </div>
